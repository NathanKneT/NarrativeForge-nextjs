...
describe('GameStore', () => {
  ...
  // ========================================
  // TESTS DE BASE (existants mais améliorés)
  // ========================================
  ...
  describe('saveGame', () => {
    it('should throw error when gameState is null', async () => {
      ...
      await expect(
        act(async () => {
          await result.current.saveGame('Timeout Test');
        })
      ).rejects.toThrow('Timeout');

      expect(result.current.isLoading).toBe(false);
      // ✅ FIX: Votre saveGame définit l'erreur correctement
  ...
  describe('Error Recovery', () => {
    it('should recover from temporary save errors', async () => {
      ...
      // ✅ FIX: Votre gameStore définit l'erreur correctement
  ...
  // ========================================
  // TESTS SPÉCIFIQUES POUR BOOST COUVERTURE
  // ========================================
  ...
  describe('GameStore Specific Methods', () => {
    ...
    // ✅ NOUVEAU: Test avec erreur non-Error
  ...
  describe('makeChoice', () => {
    ...
    // ✅ NOUVEAU: Test des edge cases makeChoice
  ...
  describe('loadGame', () => {
    ...
    // ✅ NOUVEAU: Test avec erreur dans loadGame
  ...
  describe('utility methods', () => {
    ...
    // ✅ NOUVEAU: Tests pour edge cases des utility methods
  ...
  describe('Advanced Save/Load Operations', () => {
    it('should handle loading saves with corrupt game state', () => {
      ...
      // ✅ FIX: Votre loadGame ne lève pas d'exception mais charge l'état
      act(() => {
